...
class AINewsLetterTasks():
    def fetch_news_task(self, agent):
        return Task(
            description=f'Fetch top news stories from the past 24 hours. The current time is {datetime.now()}.',
            agent=agent,
    ...
    def analyze_news_task(self, agent, context):
        return Task(
            ...
            expected_output="""A markdown-formatted analysis for each news story, including a rundown, detailed bullet points, 
                ...
                **Why it matters:** \n\n
                - While AI-related ads have been rampant over the last year, its Super Bowl presence is a big mainstream moment.\n\n'
            """
        )
